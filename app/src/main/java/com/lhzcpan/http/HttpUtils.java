...
/**
 * Created by master on 2017/12/20.
 */
...
public class HttpUtils {
     ...
     * @param listener
     */
    public static void executeGet(final Context context, final String url, final OnHttpListener listener) {
     ...
     * @param listener
     */
    public static void executePost(final Context context, final String url, final Map<String, Object> params, final OnHttpListener listener) {
