...
import static com.lhzcpan.f.tantan.CardConfig.MAX_SHOW_COUNT;
import static com.lhzcpan.f.tantan.CardConfig.SCALE_GAP;
import static com.lhzcpan.f.tantan.CardConfig.TRANS_Y_GAP;
...
/*        if (isLeftSwipe){
        ...
        //自己感受一下吧 Alpha
        if (viewHolder instanceof TanTanAdapter.ViewHolder) {
            TanTanAdapter.ViewHolder holder = (TanTanAdapter.ViewHolder) viewHolder;
