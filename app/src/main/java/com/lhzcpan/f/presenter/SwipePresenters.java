...
public class SwipePresenters implements ISwipeInterface.Presenter {

    private ISwipeInterface.View mView;
    private Context mContext;
    private List<HomeBean> list = new ArrayList<>();

    private DateFormatter formatter = new DateFormatter();

    public SwipePresenters(ISwipeInterface.View view, Context context) {
        mView = view;
        mContext = context;
    }
